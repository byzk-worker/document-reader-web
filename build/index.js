...
function actualSizeAttached(app) {
    this.scale = 1;
    var self = this;
    self._scaleBookmarkChange = _bindListener(app, "bookmarkChange", scaleBookmarkChange, this);
    self._scaleChange = _bindListener(app.getReader(), "scaleChange", scaleChange, this);
}
...
function suitablePageAttached(app) {
    this.scale = 0.8;
    var self = this;
    self._suitableScaleBookmarkChange = _bindListener(app, "bookmarkChange", suitableScaleBookmarkChange, this);
    self._suitableScaleChange = _bindListener(app.getReader(), "scaleChange", suitableScaleChange, this);
}
...
var headerTabsBtns = {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 4:
                                ...
                                return [4 /*yield*/, (_a = currentBookmark.parserWrapperInfo.parserInterface).signatureByPositionList.apply(_a, __spreadArray([res.sealInfo,
    ...
    sealQiFenAdd: {
        ...
        nodeInfo: {
            ...
            click: function (app) {
                return __awaiter(this, void 0, void 0, function () {
                    var currentBookmark, sealListResult, pwd, sealList, res, e_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                currentBookmark = app.currentBookmark();
                            ...
                            case 3:
                                ...
                                //   };
                                // });
                                return [4 /*yield*/, currentBookmark.parserWrapperInfo.parserInterface.signatureByGap(res.sealInfo, pwd, {
                                        splitPageNum: res.oneSealInPageNum,
                                        type: res.modSwitch,
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 4:
                                ...
                                app.loading.show("正在签署印章...");
                                return [4 /*yield*/, currentBookmark.parserWrapperInfo.parserInterface.signatureByKeywords(res.sealInfo, pwd, keyword)];
                            case 5:
                                _a.sent();
...
function sidebarLeftToolbarDisabled(app) {
    var currentBookmark = app.currentBookmark();
...
var ReaderParserAbstract = /** @class */ (function () {
    ...
    ReaderParserAbstract.prototype.signatureVerify = function (sealFieldName) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.signatureVerifyAll = function () {
        throw ErrNoSupportFunction;
    };
    ...
    ReaderParserAbstract.prototype.signatureByKeywords = function (sealInfo, pwd, keyword) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.signatureByPosition = function (sealInfo, password, positionInfo) {
        return this.signatureByPositionList(sealInfo, password, positionInfo);
    };
    ReaderParserAbstract.prototype.signatureByPositionList = function (sealInfo, password) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.signatureByGap = function (sealInfo, pwd, options) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.save = function (savePath) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.saveToBase64 = function () {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.saveToHttp = function (url, options) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.saveToLocalPath = function (path) {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.currentFileInfo = function () {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.close = function () {
        throw ErrNoSupportFunction;
    };
    ReaderParserAbstract.prototype.reload = function () {
        throw ErrNoSupportFunction;
    };
...
var delayList = [];
var queueAdd = function (guid, body) {
    queueRemove(guid);
    delayList.push({ id: guid, body: body });
};
var queueRemove = function (guid) {
    delayList = delayList.filter(function (m) { return m.id !== guid; });
};
var startTimeout = function (guid, time) {
    queueAdd(guid, setTimeout(function () {
        document.getElementById(guid).remove();
    }, time));
};
var endTimeout = function (guid) {
    clearTimeout(delayList.find(function (m) { return m.id === guid; }).body);
    queueRemove(guid);
};
var addDelayTask = function (guid, time) {
    startTimeout(guid, time);
    //鼠标移入事件
    document.getElementById(guid).onmouseover = function () {
        endTimeout(guid);
    };
    //鼠标离开事件
    document.getElementById(guid).onmouseout = function () {
        startTimeout(guid, time);
    };
};
...
var ReaderImpl = /** @class */ (function () {
    ...
    ReaderImpl.prototype.currentFileInfo = function () {
        var parser = this.currentParser();
        if (!parser) {
    ...
    ReaderImpl.prototype.closeCurrentFile = function () {
        var currentBookmark = this._app.currentBookmark();
        if (!currentBookmark || !currentBookmark.parserWrapperInfo) {
            return;
        }
        this._app.removeBookmarkById(currentBookmark.id);
    };
    ReaderImpl.prototype.saveCurrentFileToBase64 = function () {
        var currentBookmark = this._app.currentBookmark();
        if (!currentBookmark || !currentBookmark.parserWrapperInfo) {
            return;
        }
    ...
    ReaderImpl.prototype.saveCurrentFileToLocalPath = function (path) {
        var currentBookmark = this._app.currentBookmark();
        if (!currentBookmark || !currentBookmark.parserWrapperInfo) {
            return;
        }
        return currentBookmark.parserWrapperInfo.parserInterface.saveToLocalPath(path);
    };
    ReaderImpl.prototype.saveCurrentFileToHttp = function (url, options) {
        var currentBookmark = this._app.currentBookmark();
        if (!currentBookmark || !currentBookmark.parserWrapperInfo) {
            return;
        }
        return currentBookmark.parserWrapperInfo.parserInterface.saveToHttp(url, options);
    };
    ReaderImpl.prototype.reloadCurrentFile = function () {
        var _a;
        var pageNo = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            pageNo[_i] = arguments[_i];
        }
        var current = this.currentParser();
        if (!current) {
            return;
        }
        (_a = current.parserInterface).reload.apply(_a, pageNo);
    };
...
var AppImpl = /** @class */ (function () {
    ...
    AppImpl.prototype.removeBookmark = function (index) {
        ...
        var removeBookmark = this._bookmarkList.splice(index, 1)[0];
