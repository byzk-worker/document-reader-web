...
function handleNodeInfo(nodeInfo) {
    ...
    nodeInfo = __assign(__assign({}, nodeInfo), { evenIdList: eventIdList });
...
var styles$3 = {"app":"index-module_app__DAOOy","header":"index-module_header__NtWW5","content":"index-module_content__m20ZT"};
...
var styles$1 = {"tab":"index-module_tab__nriyF","fileName":"index-module_fileName__A6hsy","closeBtn":"index-module_closeBtn__MTrBM"};

var template$4 = "\n    <div class=\"".concat(styles$1.tab, "\">\n      <div title={{name}} class=\"").concat(styles$1.fileName, "\">\n        <sapn>{{name}}</sapn>\n      </div>\n      <div class=\"").concat(styles$1.closeBtn, "\">\n        <span title=\"\u5173\u95ED\" class=\"iconfont\">&#xe600;</span>\n      </div>\n    </div>\n");
...
var template$2 = lodash.exports.template(html)({
    styles: styles$2
});
...
var App$1 = defineComponent({
    ...
    template: "<ui-app s-show=\"show\" s-bind=\"{{{...appOptions}}}\" />",
    initData: function () {
        return {
            show: true,
            appOptions: {}
